...
- Name: lightbox.spec.ts >> citizen /track page >> clicking report thumbnail opens lightbox
- Location: e2e/lightbox.spec.ts:69:7
...
Locator: getByRole('button', { name: /view reported photo 1 full screen/i }).first()
Expected: visible
Timeout: 8000ms
...
```yaml
- text: Government of Karnataka · Udupi District Administration · Swachh Bharat Mission
- banner:
  - link "Udupi Civic Watch Udupi District Administration by Trip Nirvigna":
    - /url: /
  - button
- main:
  - heading "Report Not Found" [level=2]
  - paragraph: "We couldn't find a report with ID #80."
- contentinfo:
  - paragraph: Udupi Civic Watch · Udupi District Administration · Government of Karnataka · Swachh Bharat Mission
  - paragraph: Powered by Trip Nirvigna
