...
- [E2E dialog and map-pin locators](e2e-dialog-locators.md) — a 2nd modal makes Radix aria-hide dialogs so getByRole misses them; overlapping Leaflet pins need dispatchEvent clicks.
